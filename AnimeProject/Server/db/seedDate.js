...
async function createInitialData() {
  try {
    ...
    VALUES
      ...
      ('Hell's Paradise', 'Yuji Kaku', 'Gabimaru reigns as the strongest and most ruthless assassin in his village. But now finds himself on death row—with only one way out: retrieve the Elixir of Life from a sinister island. Longing for freedom, he accepts the challenge. But with fellow convicts vying for the same prize and demonic beasts lurking, how will Gabimaru survive this harrowing quest?', 'hellsparadise.png', 'https://www.crunchyroll.com/series/GJ0H7Q5ZJ/hells-paradise')

      ('One Piece', 'Eiichiro Oda', 'Monkey. D. Luffy refuses to let anyone or anything stand in the way of his quest to become the king of all pirates. With a course charted for the treacherous waters of the Grand Line and beyond, this is one captain who'll never give up until he's claimed the greatest treasure on Earth: the Legendary One Piece!', 'onepiece.png', 'https://www.crunchyroll.com/series/GRMG8ZQZR/one-piece'),
      ...
      ('Black Butler', 'Yana Toboso', 'Ciel Phantomhive is the most powerful boy in all of England, but he bears the scars of unspeakable suffering. Forced to watch as his beloved parents were brutally murdered, Ciel was subsequently abducted and violently tortured. Desperate to end his suffering, the boy traded his own soul for a chance at vengeance, casting his lot with the one person on whom he could depend: Sebastian, a demon Butler summoned from the very pits of hell. Together, they’ll prowl the darkest alleys of London on a mission to snuff out those who would do evil.', 'blackbutler.png', 'https://www.crunchyroll.com/series/GYQ43P3E6/black-butler')
        `);
  } catch (error) {
    throw error;
  }
