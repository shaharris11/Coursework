    ...
    await client.query(`
      ...
      CREATE TABLE likes (
       ...
       CREATE TABLE posts (
        id SERIAL PRIMARY KEY,
        title VARCHAR(50),
        animeid INTEGER REFERENCES animes(animeid),
